...
public class GameEventHandler {
	...
	@EventListener(condition = "#event.code == T(com.dainws.games.cbg.domain.event.EventCode).GAME_CREATED")
	public void onGameCreated(Event event) {
		this.sendEventToEveryPlayer(event);
	}

	@EventListener(condition = "#event.code == T(com.dainws.games.cbg.domain.event.EventCode).GAME_START")
	...
	@EventListener(condition = "#event.code == T(com.dainws.games.cbg.domain.event.EventCode).GAME_END_WITH_WINNER")
	...
	@EventListener(condition = "#event.code == T(com.dainws.games.cbg.domain.event.EventCode).GAME_END_WITH_TIE")
	...
	@EventListener(condition = "#event.code == T(com.dainws.games.cbg.domain.event.EventCode).TURN_CHANGE")
	...
	@EventListener(condition = "#event.code == T(com.dainws.games.cbg.domain.event.EventCode).ROUND_CHANGE")
