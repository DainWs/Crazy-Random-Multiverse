import { MinimalSettings, Settings, SettingName, SettingValue, SettingSection } from "@/domain/SettingsRepository";
...
function parseToObject(stringObject: string): Settings {
    ...
    return {
        username: minimalSettings?.username ?? `user_${new Date().getTime()}`,
    }
}
