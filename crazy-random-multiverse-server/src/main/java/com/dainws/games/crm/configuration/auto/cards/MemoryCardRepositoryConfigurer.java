...
public class MemoryCardRepositoryConfigurer extends AbstractCardRepositoryConfigurer<MemoryCardRepository> {

	@Override
	public void configure(MemoryCardRepository cardRepository) {
		try {
