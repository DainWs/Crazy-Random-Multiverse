...
function createAction(game: Game, source: ActionSource, target: ActionTarget): Action {
  return {
    game: game.code,
    type: actionResolver.resolveType(source.sourceTrigger, target.targetTrigger),
